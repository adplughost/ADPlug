<?php 
/**
 * Template name: Sign Up Advertiser
 */
get_header('login');
?>
          ...
          <div class="p-login__login-social">
            <div class="auth-social">
              <a 
                ...
                href="<?= home_url('/sign-up-details-for-advertiser') ?>" 
                aria-label="Facebook"
              ></a>
              <a 
          ...
          <form class="form form-login form-sign-up" action="/" method="POST">
            <div class="form-sign-up__status">
              <label class="form__radio form-sign-up__status-item">
                <input class="form__radio-input" type="radio" name="status" value="advertiser" checked />
                <span class="form__radio-circle"></span>
                I'm an Advertiser
              </label>
              <label class="form__radio form-sign-up__status-item">
                <input class="form__radio-input" type="radio" name="status" value="creator" />
                <span class="form__radio-circle"></span>
                I'm an creator
              </label>
            </div>
            ...
            <div class="form-login__footer form-sign-up__footer">
              ...
              <!-- <button class="button form__submit form-sign-up__submit" type="submit">
                Register now as&nbsp;<span class="form-sign-up__submit-status">Advertiser</span>
              </button> -->
              <a 
