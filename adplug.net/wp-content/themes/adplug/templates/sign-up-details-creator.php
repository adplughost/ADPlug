<?php 
/**
 * Template name: Sign Up Details Creator
 */
get_header('sign-up');
?>
<main>
  <div class="container p-reg-details__wrapper">
    ...
    >
      <div id="step-1" class="reg-form__step">
        <div class="reg-form__status">
          <span class="reg-form__title reg-form__status-title"
            >I want to</span
          >
          <div class="reg-form__status-items">
            <label class="reg-form__status-label">
              <input
                class="reg-form__status-input"
                type="radio"
                name="status"
                value="Fitting Model"
                checked
              />
              <span class="reg-form__status-label-text">Fitting Model</span>
            </label>
            <label class="reg-form__status-label">
              <input
                class="reg-form__status-input"
                ...
                value="Photo Model"
              />
              <span class="reg-form__status-label-text">Photo Model</span>
            </label>
            <label class="reg-form__status-label">
              <input
                class="reg-form__status-input"
                ...
                value="Creator"
              />
              <span class="reg-form__status-label-text">Creator</span>
            </label>
          </div>
        </div>
        <div class="reg-form__details">
          ...
          <label class="reg-form__label">
            <span class="reg-form__label-text">Social</span>
            <input
              class="reg-form__input"
              type="url"
              name="website"
