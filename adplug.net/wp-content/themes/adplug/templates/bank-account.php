...
<main class="container p-profile__main p-settings__main">
  ...
  <div class="b-bank-account">
    <form class="form form-settings b-bank-account__form" action="/" method="POST">
      <div class="form-settings__fieldset">
        <span class="form-settings__legend">Bank account</span>
    ...
    <div class="b-bank-account__history">
      <span class="b-bank-account__history-title">Transaction history</span>
