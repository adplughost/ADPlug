...
<main>
  <div class="p-models__promo">
    <div class="container p-models__promo-container">
      ...
      <div class="video p-models__promo-video">
        <video 
          class="video__stream" 
          src="<?= get_template_directory_uri(); ?>/assets/img/brands-video.mp4" 
          poster="<?= get_template_directory_uri(); ?>/assets/img/brands-video-poster.jpeg" 
          autoplay 
          muted
        ></video>
  ...
  <div class="p-models__partners">
    <div class="container">
      <h2 class="title p-models__partners-title">We are chosen by</h2>
    </div>
