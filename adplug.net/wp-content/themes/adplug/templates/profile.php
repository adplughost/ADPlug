...
<main class="container p-profile__main">
  ...
  <div class="b-profile">
    ...
    <div class="b-profile__item b-profile__albums">
      ...
      <a class="b-profile__albums-more" href="<?php home_url('/albums'); ?>">view all photos</a>
  ...
  <div class="p-profile__aside">
    ...
    <div class="p-profile__aside-item">
      ...
      <div class="profile-reviews">
        <div class="profile-reviews__items">
          <div class="profile-reviews__item">
            <div class="profile-reviews__item-header">
              <img 
                class="profile-reviews__item-image" 
                src="<?= get_template_directory_uri(); ?>/assets/img/reviews-item-1.jpg" 
                alt="Alt" 
              />
              <span class="profile-reviews__item-name">Jose Wagner</span>
              <span class="profile-reviews__item-company">Company</span>
            </div>
            <span class="profile-reviews__item-status">Model for presentation</span>
            <p class="profile-reviews__item-text">
              Guys! You are the best! Everything is fast and clear,
              everything is fine, I’m glad that I found you and stayed with
              you!
            </p>
          ...
          <div class="profile-reviews__item">
            <div class="profile-reviews__item-header">
              <img 
                class="profile-reviews__item-image" 
                src="<?= get_template_directory_uri(); ?>/assets/img/reviews-item-2.jpg" 
                alt="Alt" 
              />
              <span class="profile-reviews__item-name">Jose Wagner</span>
              <span class="profile-reviews__item-company">Company</span>
          ...
          <div class="profile-reviews__item">
            <div class="profile-reviews__item-header">
              <img 
                class="profile-reviews__item-image" 
                src="<?= get_template_directory_uri(); ?>/assets/img/reviews-item-3.jpg" 
                alt="Alt" 
              />
        ...
        <a class="profile-reviews__more" href="#">see more reviews</a>
      </div>
    </div>
  </div>
</main>
